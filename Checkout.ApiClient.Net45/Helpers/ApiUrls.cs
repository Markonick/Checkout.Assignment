namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _shoppingGetItemApiUri;
        private static string _shoppingAddItemApiUri;
        ...
        public static void ResetApiUrls()
        {
            ...
            _shoppingGetItemApiUri = null;
            _shoppingAddItemApiUri = null;
        }

        public static string ShoppingList
            => _shoppingListApiUri ?? (_shoppingListApiUri = string.Concat(AppSettings.BaseApiUri, "/shopping"));
        public static string ShoppingAddItem
            => _shoppingAddItemApiUri ?? (_shoppingAddItemApiUri = string.Concat(AppSettings.BaseApiUri, "/shopping/{0}/{1}"));
        public static string ShoppingItem
            => _shoppingGetItemApiUri ?? (_shoppingGetItemApiUri = string.Concat(AppSettings.BaseApiUri, "/shopping/{0}"));
